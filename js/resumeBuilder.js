...
"proj" : [
		...
		},
		{
			...
			"desc" 	: "Attempting to learn web developement; this responsive web resume was the first website I created. With the use of HTML/CSS and JavaScript; this webpage adjusts itself to the device it is being viewed on i.e., it is device independent and can be viewed with no zooming in/out to see the content.<br><i><small>The same can be viewed on my LinkedIn profile mentioned below.</small></i>"
		},
		{
